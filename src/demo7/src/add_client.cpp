...
*/
typedef actionlib::SimpleActionClient<demo7::AddIntsAction> Client;


//处理最终结果
void done_cb(const actionlib::SimpleClientGoalState &state, const demo7::AddIntsResultConstPtr &result){
...
//处理连续反馈
void  feedback_cb(const demo7::AddIntsFeedbackConstPtr &feedback){
