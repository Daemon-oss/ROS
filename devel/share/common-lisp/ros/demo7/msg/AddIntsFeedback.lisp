...
(cl:defmethod cl:initialize-instance :after ((m <AddIntsFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddIntsFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name demo7-msg:<AddIntsFeedback> is deprecated: use demo7-msg:AddIntsFeedback instead.")))

(cl:ensure-generic-function 'progress_bar-val :lambda-list '(m))
(cl:defmethod progress_bar-val ((m <AddIntsFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo7-msg:progress_bar-val is deprecated.  Use demo7-msg:progress_bar instead.")
  (progress_bar m))
