...
if("TRUE" STREQUAL "TRUE")
  set(URDF_SOURCE_PREFIX /home/wex/ros_ws/src/URDF)
  set(URDF_DEVEL_PREFIX /home/wex/ros_ws/devel)
  set(URDF_INSTALL_PREFIX "")
  set(URDF_PREFIX ${URDF_DEVEL_PREFIX})
else()
  set(URDF_SOURCE_PREFIX "")
  set(URDF_DEVEL_PREFIX "")
  set(URDF_INSTALL_PREFIX /home/wex/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'URDF' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wex/ros_ws/src/URDF/${idir}'.  ${_report}")
    endif()
