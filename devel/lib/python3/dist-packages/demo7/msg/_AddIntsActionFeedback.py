...
"""autogenerated by genpy from demo7/AddIntsActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class AddIntsActionFeedback(genpy.Message):
  ...
  _type = "demo7/AddIntsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','demo7/AddIntsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = demo7.msg.AddIntsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = demo7.msg.AddIntsFeedback()
